...
affine_ops = ["rotate", "shear_x", "shear_y", "trans_x", "trans_y"]
...
def rand_augment_both(
    im, mask, magnitude, ops, n_ops=2, prob=1.0, fill=(128, 128, 128), ignore_value=255
):
...
if __name__ == "__main__":
    im = Image.open(
        "cityscapes_dataset_half2/leftImg8bit/train/cologne/cologne_000114_000019_leftImg8bit.png"
    )
    w, h = im.size[0], im.size[1]
