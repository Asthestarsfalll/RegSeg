...
def poly_lr_scheduler(
    current_iter, total_iters, warmup_iters, warmup_factor, poly_power=0.9
):
    lr = (1 - current_iter / total_iters) ** poly_power
...
LR_SCHEDULERS = {
    "poly": poly_lr_scheduler,
    "exp": exp_lr_scheduler,
    "cos": cosine_lr_scheduler,
